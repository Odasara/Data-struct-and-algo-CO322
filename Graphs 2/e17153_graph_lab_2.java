...
public class DPQ {
    ...
    // Method 2- To process all the neighbors of the passed node
    ...
    public static void main(String arg[])
    {
        ...
        //Calculating the shortest path from source1
        DPQ pq1 = new DPQ(v);
        pq1.dijkstra(adj, source1);
        
        //Calculating the shortest path from source2
        DPQ pq2 = new DPQ(v);
        pq2.dijkstra(adj, source2);

        //Printing the shortest path to all the nodes from the sorce node
        System.out.println("Considering shortest paths : ");

        for(int i=2; i<pq1.dist.length;i++){
            //checking whether which source has the minimum cost
            if(pq1.dist[i]<pq2.dist[i]){
            	System.out.println("* S"+source1 + " is the supplier for Node " + i+".  Cost is " + pq1.dist[i]);
            }else{
                System.out.println("* S"+source2 + " is the supplier for Node " + i+".  Cost is " + pq2.dist[i]);
